...
JDBC_JAR_SOURCE = "/jar_file/postgresql-42.2.14.jre7.jar"
JDBC_JAR_DEST = os.path.join(JDBC_PATH, "postgresql-42.2.14.jre7.jar")


def write_input_files_to_host():
